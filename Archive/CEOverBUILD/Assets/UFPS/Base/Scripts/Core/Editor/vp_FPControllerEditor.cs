...
public class vp_FPControllerEditor : Editor
{
	...
	public virtual void DoMotorMoveFoldout()
	{
		...
		if (m_MotorMoveFoldout)
		{
			...
			m_Component.MotorAcceleration = EditorGUILayout.Slider("Acceleration", m_Component.MotorAcceleration, 0, 10);
	...
	public virtual void DoMotorJumpFoldout()
	{
		...
		if (m_MotorJumpFoldout)
		{
            ...
            m_Component.MotorWallJumpForce = EditorGUILayout.Slider("Wall Jump Force", m_Component.MotorWallJumpForce, 0, 1);
            ...
            m_Component.CanDoubleJump = EditorGUILayout.Toggle("Can Double Jump", m_Component.CanDoubleJump); // MAX - Adds Double Jump to Editor Inspector
            m_Component.hasWallJump = EditorGUILayout.Toggle("Can Wall Jump", m_Component.hasWallJump);
            vp_EditorGUIUtility.Separator();
		}
